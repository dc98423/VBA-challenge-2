'name this something more discriptive. Imagine if you had 100 modules.
attribute VB_Name = "Module1"
'I like that you are keeping it explicit. Makes it easier to tell whats going on and will reduce errors down the road
Option Explicit
'Define columns
'I like to alphabatize declarations
...
'i would love to see this alphabetized
    Dim ws As Worksheet
    ...
    'Love the name Stocksheets but I would camelcase this StockSheets
    Stocksheets = ActiveWorkbook.Worksheets.Count
    'rename sheetnum to currentSheet or sheetNumber
    For SheetNum = 1 To Stocksheets
        ...
        With ws
            ...
            ' I like that you trim, add a lowercase function as well.
            'case statment rules, way to go!
            SheetName = .Name
